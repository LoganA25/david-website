        ...
        <div className="text-white">
            <div className="flex items-center justify-center">
                <div className="pt-8 lg:w-3/4 w-11/12 rounded text-white">
                    <div>
                        <div id="entertainment" className="px-4 py-4 text-3xl font-bold text-center bg-black rounded-t-lg lg:scroll-m-32 scroll-m-[900px]">Entertainment</div>
                        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 bg-black rounded-b-lg px-4 py-4 text-center mb-24">
                            <div>
                                ...
                                <p className="text-start md:pb-0 lg:pb-0 pb-8">
                                    ...
                                    a polished presentation that aligns with HeyDominik&apos;s high-energy content style.</p>
                            </div>
                            <div>
                                <iframe
                                    className="w-full aspect-video rounded-lg border-8"
                                ...
                                <p className="text-start md:pb-0 lg:pb-0 pb-8">
                                    ...
                                    satirical takes on internet culture, reaction videos, and collaborations. The editing enhances the
                                    comedic timing, creating a dynamic and engaging viewer experience.</p>
                            </div>
                        </div>
                        <div id="education" className="px-4 py-4 text-3xl font-bold text-center scroll-m-32 bg-black rounded-t-lg lg:scroll-m-32 scroll-m-[900px]">Education</div>
                        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 bg-black rounded-b-lg px-4 py-4 text-center mb-24">
                            <div>
                                <iframe
                                    className="w-full aspect-video rounded-lg border-8"
                                ...
                                <p className="text-start md:pb-0 lg:pb-0 pb-8">
                                    ...
                                    editing style supports in-depth commentary, making complex strategies more accessible while
                                    keeping viewers engaged with polished, informative visuals.</p>
                            </div>
                            <div>
                                <iframe
                                    className="w-full aspect-video rounded-lg border-8"
                                ...
                                <p className="text-start md:pb-0 lg:pb-0 pb-8">
                                    ...
                                    The edit complements the in-depth breakdowns and brings a visually captivating layer to the
                                    engaging commentary.</p>
                            </div>
                        </div>
                        <div id="gaming" className="px-4 py-4 text-3xl font-bold text-center scroll-m-32 bg-black rounded-t-lg lg:scroll-m-32 scroll-m-[900px]">Gaming</div>
                        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 bg-black rounded-b-lg px-4 py-4 text-center mb-24">
                            <div>
                                <iframe
                                    className="w-full aspect-video rounded-lg border-8"
                                ...
                                <p className="text-start md:pb-0 lg:pb-0 pb-8">
                                    ...
                                    action. From dynamic gameplay highlights to challenge videos and tutorials, the editing style
                                    enhances the energy and excitement of each video, creating a polished and entertaining
                            ...
                            <div>
                                ...
                                <p className="text-start md:pb-0 lg:pb-0 pb-8">
                                    ...
                                    alive as I tackle unique obstacles, uncover hidden strategies, and race against the clock,
                                    creating an engaging experience that&apos;s as immersive as it is entertaining.</p>
                            </div>
                        </div>
                        <div id="music" className="px-4 py-4 text-3xl font-bold text-center scroll-m-32 bg-black rounded-t-lg lg:scroll-m-32 scroll-m-[900px]">Music</div>
                        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 bg-black rounded-b-lg px-4 py-4 text-center mb-24">
                            <div>
                                <iframe
                                    className="w-full aspect-video rounded-lg border-8"
                                ...
                                <p className="text-start md:pb-0 lg:pb-0 pb-8">
                                    ...
                                    the editing enhances the raw emotion and powerful storytelling in the track. The polished visuals
                                    and engaging flow create a striking, cinematic music video experience.</p>
                            </div>
                            <div>
                                <iframe
                                    className="w-full aspect-video rounded-lg border-8"
                        ...
                        <div id="trailers" className="px-4 py-4 text-3xl font-bold text-center scroll-m-32 bg-black rounded-t-lg lg:scroll-m-32 scroll-m-[900px]">Trailers</div>
                        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 bg-black rounded-b-lg px-4 py-4 text-center mb-24">
                            <div>
                                <iframe
                                    className="w-full aspect-video rounded-lg border-8"
